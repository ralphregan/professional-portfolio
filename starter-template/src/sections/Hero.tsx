import memojiImage from '@/assets/images/PersonOneComputerEdit.png'
import Image from 'next/image';
import ArrowDown from '@/assets/icons/arrow-down.svg';
import grainImage from "@/assets/images/grain.jpg";
import StarIcon from "@/assets/icons/star.svg"
export const HeroSection = () => {
  return <div className='py-32 md:py-44 lg:py-58 relative z-0 overflow-x-clip'>
...
<div className='border border-red-500 inline-flex animate-spin [animation-duration:10s] ' >
  <StarIcon className="size-28 text-orange-300" />
  </div>
</div> 
        <div className="container">
      <div className='flex flex-col items-center'>
<Image src={memojiImage} className='size-[100px] md:size-[140px]  ' alt='Person peeking from behind laptop'/>
<div className='bg-gray-950 border border-gray-800 px-4 py-1.5
...
<h1 className='font-serif text-3xl md:text-5xl lg:text-6xl text-center mt-8 tracking-wide'>Building Reality From Imagination </h1>
<p className='mt-4 text-center text-white/60 md:text-lg' >I specialize in transforming designs into functional,
 high-performing web applications. Let&apos;s  discuss  next project</p>
      </div>
    <div className='flex flex-col md:flex-row justify-center items-center mt-8 gap-4'>
      <button className='inline-flex items-center gap-2 border
      border-white/15 px-6 h-12 rounded-xl '>
        <span className='font-semibold hover:font-extrabold transition
        duration-300'>Explore My Work</span>
